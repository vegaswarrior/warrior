        ...
        <div className="h-full bg-gradient-to-tl from-green-400 to-indigo-900 w-full py-16 px-4">
            <div className="flex flex-col items-center justify-center">
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <p className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">Dont have account? <Link href="#"   className="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none  text-gray-800 cursor-pointer"> Sign up here</Link></p>
                    ...
                    <div className="w-full flex items-center justify-between py-5">
                        ...
                        <div>
                            ...
                            <input aria-labelledby="name" type="text" className="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" id='name' value={name} onChange={onChange}/>
                        </div>
                        <div>
                            <label id="email" className="text-sm font-medium leading-none text-gray-800">Email</label>
                            <input aria-labelledby="email" type="email" className="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" id='email' value={email} onChange={onChange}/>
                        </div>
                        <div className="mt-6  w-full">
                            <label className="text-sm font-medium leading-none text-gray-800"> Password</label>
                            <div className='passwordInputDiv relative flex items-center justify-center'>
                              <input type={showPassword ? 'text' : 'password'} className='passwordInput bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2' placeholder='Password' id='password' value={password} onChange={onChange}/>
                              {/* <img src={visibilityIcon} alt='show password' className='showPassword' onClick={() => setShowPassword((prevState) => !prevState)}/> */}
                           </div>
                        </div>
                        <div className="mt-8">
                            <button role="button" className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">Login Into My Account</button>
                        </div>
                    </form>
                </div>
            </div>
