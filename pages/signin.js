                ...
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <div className="w-full flex items-center justify-between py-5">
                        ...
                        <div>
                            ...
                            <input type="email" className="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" id='email' value={email} onChange={onChange}/>
                        </div>
                        ...
                        <div className="mt-8">
                            <button className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">Login Into My Account</button>
                        </div>
                    </form>
                    <Link href='/forgotpassword' className=''>Forgot Passord?</Link>
                </div>
            </div>
